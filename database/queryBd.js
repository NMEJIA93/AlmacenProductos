const ProductQuery = {
    ...
    updateProducto: 'UPDATE productoAlmacen SET  nomProducto=@nomProducto,categoriaProducto=@categoriaProducto,descripcion=@descripcion,valorUnitario=1000, marca=@marca,modelo=@modelo WHERE refProducto = @refProducto',
